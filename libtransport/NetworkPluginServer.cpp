...
class NetworkConversation : public Conversation {
	public:
		...
		boost::signal<void (NetworkConversation *, std::shared_ptr<Swift::Message> &)> onMessageToSend;
};
...
#else
void NetworkPluginServer::handleElement(std::shared_ptr<Swift::Element> element) {
#endif
